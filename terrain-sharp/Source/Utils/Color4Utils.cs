namespace terrain_sharp.Source.Utils {
	...
	public static class Color4Utils {
		...
		public static int[] color_mix = new int[] {
		...
		public static Color4 Add(Color4 c1, Color4 c2) {
			return new Color4(c1.R + c2.R, c1.G + c2.G, c1.B + c2.B, c1.A);
		}

		public static Color4 Substract(Color4 c1, Color4 c2) {
			return new Color4(c1.R - c2.R, c1.G - c2.G, c1.B - c2.B, c1.A);
		}

		public static Color4 Multiply(Color4 c1, Color4 c2) {
			return new Color4(c1.R * c2.R, c1.G * c2.G, c1.B * c2.B, c1.A);
		}
		...
		public static bool Compare(Color4 c1, Color4 c2) {
			return (c1.R == c2.R && c1.G == c2.G && c1.B == c2.B);
		}

		public static Color4 Interpolate(Color4 c1, Color4 c2, float delta) {
			float r = MathUtils.Interpolate(c1.R, c2.R, delta);
			float g = MathUtils.Interpolate(c1.G, c2.G, delta);
			float b = MathUtils.Interpolate(c1.B, c2.B, delta);
			float a = MathUtils.Interpolate(c1.A, c2.A, delta);
