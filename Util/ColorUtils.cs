namespace FrontierSharp.Util {
    ...
    public static class ColorUtils {
        ...
        public static Color4 Color4Unique(int i) {
            Color4 c = new Color4();
            i = COLOR_MIX[i % 512];

            c.A = 1.0f;
            c.R = 0.3f + ((i & 1)!= 0 ? 0.15f : 0.0f) + ((i & 8)!= 0 ? 0.2f : 0.0f) - ((i & 64)!= 0 ? 0.35f : 0.0f);
            c.G = 0.3f + ((i & 2)!= 0 ? 0.15f : 0.0f) + ((i & 32)!= 0 ? 0.2f : 0.0f) - ((i & 128)!= 0 ? 0.35f : 0.0f);
            c.B = 0.3f + ((i & 4)!= 0 ? 0.15f : 0.0f) + ((i & 16)!= 0 ? 0.2f : 0.0f) - ((i & 256)!= 0 ? 0.35f : 0.0f);
            return c;
        }
...
GLrgba glRgbaFromHsl(float h, float sl, float l)
{
    ...
    g = l;
    b = l;
    v = (l <= 0.5f) != 0 ? (l * (1.0f + sl)) : (l + sl - l * sl);
    if (v > 0)
    {
        float m;
        float sv;
